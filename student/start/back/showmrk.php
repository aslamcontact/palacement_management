     ...
     while($init <= 6)
       {
                        ...
                        $tab.="<br><br><table class=\"small\"><tr><th  class=\"row\" colspan=3><center>".$init."st Sem</center></th></tr><tr><th class=\"row\">Subject</th><th class=\"row\">mark</th><th class=\"row\">Status</th></tr>";
                      foreach($res as $v => $i)
                        {
                                  if($init==$i['sem'])
                                    {
