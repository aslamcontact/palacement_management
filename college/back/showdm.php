    ...
    if($t==0)
     {
                    ...
                    $tab="<table><tr><th class=\"row\"  colspan=\"2\"><center>Basic Details</center></th></tr><tr class=\"rnum\"><td class=\"row\">reg</td><td class=\"row\">".$row['reg']."</td></tr>
                    ...
                    </tr></table><br><table><tr><th class=\"row\"  colspan=\"2\"><center>Percentage Details</center></th></tr>
                    ...
                    <tr class=\"rnum\"><td class=\"row\">Semester</td><td class=\"row\">".$row3['sem']."</td></tr></table>";
